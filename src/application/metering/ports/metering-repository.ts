...
import type {
  PublishedUsagePricing,
  PublishUsagePricingInput,
} from "../services/usage-pricing-admin-service.js";
import type {
  UsagePriceRate,
  UsageQuote,
} from "../services/usage-pricing-service.js";
import type {
  AuthorizeUsageInput,
...
export interface BillingAdmissionRepository {
  ...
  recordExecutionEvent(input: ExecutionEventInput): Promise<{
