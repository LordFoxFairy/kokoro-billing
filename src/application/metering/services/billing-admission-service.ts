...
export class BillingAdmissionService {
  ...
  public release(input: ReleaseAdmissionInput): Promise<BillingAdmissionResult> { return this.transaction.withTransaction(() => this.repository.release(input)); }
