...
export type CheckoutRepositoryOptions = { readonly hostedProvider?: HostedCheckoutProvider; readonly publicBaseUrl?: string };

export const createPostgresCheckoutService = (connection: SqlConnection, options: CheckoutRepositoryOptions = {}): CheckoutService => new CheckoutService(new PostgresCheckoutRepository(connection, options), connection);
export const createPostgresCatalogAdminService = (connection: SqlConnection): CatalogAdminService => new CatalogAdminService(new PostgresCatalogAdminRepository(connection), connection);
export const createPostgresCatalogService = (connection: SqlConnection): CatalogService => new CatalogService(new PostgresCatalogRepository(connection));
export const createPostgresCreditAccountQueryService = (connection: SqlConnection): CreditAccountQueryService => new CreditAccountQueryService(new PostgresCreditAccountRepository(connection), connection);
export const createPostgresAdminGrantService = (connection: SqlConnection): AdminGrantService => new AdminGrantService(new PostgresAdminGrantRepository(connection), connection);
export const createPostgresGrantExpiryService = (connection: SqlConnection): GrantExpiryService => new GrantExpiryService(new PostgresGrantExpiryRepository(connection), connection);
export const createPostgresRedeemAdminService = (connection: SqlConnection, secret: string): RedeemAdminService => new RedeemAdminService(new PostgresRedeemAdminRepository(connection, secret), connection);
export const createPostgresRedeemService = (connection: SqlConnection, secret: string): RedeemService => new RedeemService(new PostgresRedeemRepository(connection, secret), connection);
export const createPostgresSubscriptionGrantService = (connection: SqlConnection): SubscriptionGrantService => new SubscriptionGrantService(new PostgresSubscriptionGrantRepository(connection), connection);
export const createPostgresUsagePricingAdminService = (connection: SqlConnection): UsagePricingAdminService => new UsagePricingAdminService(new PostgresUsagePricingAdminRepository(connection), connection);
export const createPostgresUsagePricingService = (connection: SqlConnection): UsagePricingService => new UsagePricingService(new PostgresUsagePricingRepository(connection));
export const createPostgresUsageSettlementService = (connection: SqlConnection): UsageSettlementService => new UsageSettlementService(new PostgresUsageSettlementRepository(connection), connection);
export const createPostgresBillingAdmissionService = (connection: SqlConnection, usage: Pick<UsageSettlementService, 'authorizeUsage' | 'settleUsage' | 'releaseUsage' | 'ensureUsageEventForHold'>): BillingAdmissionService => new BillingAdmissionService(new PostgresBillingAdmissionRepository(connection, usage), connection);
export const createPostgresBillingSettlementService = (connection: SqlConnection): BillingSettlementService => new BillingSettlementService(new PostgresBillingSettlementRepository(connection), connection);
export const createPostgresProviderEventAdminService = (connection: SqlConnection): ProviderEventAdminService => new ProviderEventAdminService(new PostgresProviderEventAdminRepository(connection), connection);
export const createPostgresProviderEventInboxService = (connection: SqlConnection): ProviderEventInboxService => new ProviderEventInboxService(new PostgresProviderEventInboxRepository(connection), connection);
export const createPostgresProviderAccountService = (connection: SqlConnection): ProviderAccountService => new ProviderAccountService(new PostgresProviderAccountRepository(connection));
export const createPostgresBillingReversalService = (connection: SqlConnection): BillingReversalService => new BillingReversalService(new PostgresBillingReversalRepository(connection), connection);
export const createPostgresProviderEventProcessor = (connection: SqlConnection, providers: ProviderRegistry, settlement: Pick<BillingSettlementService, 'recordSettlement' | 'fulfillSettlement'>, reversal: Pick<BillingReversalService, 'recordReversal' | 'reverseCredits'>, subscriptionGrant: Pick<SubscriptionGrantService, 'grant'>): ProviderEventProcessor => new ProviderEventProcessor(new PostgresProviderEventProcessorRepository(connection, providers, settlement, reversal, subscriptionGrant), connection);
export const createPostgresAdminStatsService = (connection: SqlConnection): AdminStatsService => new AdminStatsService(new PostgresAdminStatsRepository(connection));
export const createPostgresReconciliationService = (connection: SqlConnection): ReconciliationService => new ReconciliationService(new PostgresReconciliationRepository(connection));
export const createPostgresSubscriptionQueryService = (connection: SqlConnection): SubscriptionQueryService => new SubscriptionQueryService(new PostgresSubscriptionRepository(connection));
